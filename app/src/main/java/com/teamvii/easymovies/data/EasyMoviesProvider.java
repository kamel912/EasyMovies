...
public class EasyMoviesProvider extends ContentProvider {
    private static final String LOG_TAG = EasyMoviesProvider.class.getSimpleName();
    public static final int CODE_FAVORITES = 100;
    public static final int CODE_SINGLE_FAVORITE = 101;

    private static final UriMatcher uriMatcher = buildUriMatcher();
    private EasyMoviesDbHelper dbHelper;

    public static UriMatcher buildUriMatcher() {
        final UriMatcher matcher = new UriMatcher(UriMatcher.NO_MATCH);
        final String authority = EasyMoviesContract.CONTENT_AUTHORITY;
        matcher.addURI(authority, EasyMoviesContract.PATH_FAVORITES, CODE_FAVORITES);
        matcher.addURI(authority, EasyMoviesContract.PATH_FAVORITES + "/#", CODE_SINGLE_FAVORITE);
        return matcher;
    }

    @Override
    public boolean onCreate() {
        dbHelper = new EasyMoviesDbHelper(getContext());
        return true;
    }
