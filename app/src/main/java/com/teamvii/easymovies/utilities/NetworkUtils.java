package com.teamvii.easymovies.utilities;
...
import com.teamvii.easymovies.api.MyApiKey;
...
public class NetworkUtils {
    ...
    private final static String api_key = MyApiKey.API_KEY;
    ...
    public static URL buildUrl(String... URL_SEGMENTS) throws MalformedURLException {
