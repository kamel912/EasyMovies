...
import com.teamvii.easymovies.adapters.MoviesAdapter;
import com.teamvii.easymovies.loaders.FavoritesLoader;
import com.teamvii.easymovies.loaders.MoviesLoader;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int gridColumns = EasyMoviesUtilities.calculateNoOfColumns(this);
    ...
    public void onLoadFinished(Loader loader, Object data) {
        ...
        if (data != null) {
            ...
            if (loader instanceof MoviesLoader) {
                ...
                movies = EasyMoviesUtilities.getMoviesFromCursor((Cursor) data);
                if (movies.size() == 0) {
                    showErrorMessage();
